...
(function ($) {
    $.fn.linkPreview = function (options) {
        ...
        $(this).append('<div class="link-preview-wrapper"><div id="previewLoading_' + selector + '" class="previewLoading"></div><textarea type="text" id="text_' + selector + '" placeholder="' + opts.placeholder + '" class="form-control message" rows="1" name="content"/></textarea> <div id="preview_' + selector + '" class="media preview-box"> <div id="previewImages_' + selector + '" class="media-left"> <div id="previewImage_' + selector + '" class="previewImage"><img src="'+loader+'"/></div><input type="hidden" id="photoNumber_' + selector + '" class="photoNumber" value="0"/> </div><div id="previewContent_' + selector + '" class="media-body"> <div id="closePreview_' + selector + '" title="Remove" class="closePreview" > </div><div id="previewTitle_' + selector + '" class="previewTitle"></div><div id="previewUrl_' + selector + '" class="previewUrl"></div><p id="previewDescription_' + selector + '" class="rb-description"></p><div id="hiddenDescription_' + selector + '" class="hiddenDescription"></div><ul id="previewButtons_' + selector + '" class="list-inline" > <li><button type="button" id="previewPreviousImg_' + selector + '" class="btn btn-sm"><i class="fa fa-caret-left"></i></button></li><li><button type="button" id="previewNextImg_' + selector + '" class="btn btn-sm" ><i class="fa fa-caret-right"></i></button></li><li><span id="photoNumbers_' + selector + '" class="photoNumbers" ></span></li><li><span id="chooseThumbnail_' + selector + '" class="chooseThumbnail"> Choose a thumbnail </span></li></ul> <div class="nT" id="nT_' + selector + '" > <span id="noThumbDiv_' + selector + '" class="noThumbDiv" > <input type="checkbox" id="noThumb_' + selector + '" class="noThumb noThumbCb"/> No thumbnail </span> </div></div></div></div>');
