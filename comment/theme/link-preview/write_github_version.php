...
$(function(){
    ...
    var theme_dir='<?php echo $g['dir_comment_skin']?>';
    var upload_dir='<?php echo $g['dir_comment_module']?>files/';
    var process_url = rooturl+'/?m=comment&a=theme/<?php echo $d['comment']['theme']?>/_action/a.multi_file_upload&upload_dir='+upload_dir+'&theme_dir='+theme_dir; //PHP script
