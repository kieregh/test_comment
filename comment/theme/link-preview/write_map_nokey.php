        ...
        <div class="share-form">
            ...
            <div class="share">
                ...
                <div id="place-box" class="shareType-box hide">
                    <div><input id="autocomplete" placeholder="장소나 주소를 입력해주세요" type="text" name="location" class="form-control"></div>
...
function initialize() {
    ...
    google.maps.event.addListener(autocomplete, 'place_changed', function () {
        ...
        document.getElementById('address').value = address+' '+place.name;
        document.getElementById('Lat').value = Lat;
        document.getElementById('Lng').value =Lng;
        initMap(Lat,Lng,place.name,address);
    });
}
...
<!-- <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCZ8EeFrfenX5wvMemxyUshWRbPcJRt6vQ&callback=initMap"></script>
